...
import { assertExpectedAccount } from 'App/Services/Social/AccountGuard'
...
export default class Authentication {
  ...
  public async getInstagramUserId(): Promise<string> {
    ...
    // Dernier rempart avant une publication irréversible : cf. AccountGuard.
    assertExpectedAccount({
      channel: 'Instagram',
      username: data.username,
      expected: Env.get('INSTAGRAM_EXPECTED_USERNAME') as string | undefined,
    })
