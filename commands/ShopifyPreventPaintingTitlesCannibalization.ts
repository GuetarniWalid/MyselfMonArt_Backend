...
export default class ShopifyPreventPaintingTitlesCannibalization extends BaseCommand {
  public static commandName = 'shopify:prevent_painting_titles_cannibalization'
  public static description = 'Prevent painting titles cannibalization'
  ...
  public async run() {
    ...
    for (const product of productsToUpdate) {
      const seo = new SEO()
      const result = await seo.preventTitleCannibalization(product)
